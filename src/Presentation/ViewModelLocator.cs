...
public static class ViewModelLocator
{
    ...
    {
        InterfaceAssembly = System.Reflection.Assembly.GetAssembly(typeof(UexCorpDataRunner.Interface.StartupExtensions));
    ...
    private static Type? FindViewModel(Type viewType)
    {
        ...
        Type? viewModelType = InterfaceAssembly?.GetType(viewName);
